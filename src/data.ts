...
export const AUTHORS: Author[] = [
  ...
  { name: 'Runyi Li', aff: [8] },
  { name: 'Shiyi Du', aff: [9] },
  { name: 'Xu Huang', aff: [10] },
  { name: 'Chenyu Tang', aff: [11] },
  { name: 'Xuhang Chen', aff: [11] },
